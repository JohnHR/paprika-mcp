#!/usr/bin/env python3
"""Apply approved category changes from the staging file to the Paprika database.

Reads the merged staging file and applies all add/remove operations.
Batches all changes into a single Paprika kill/restart cycle.
"""
...
def main():
    ...
    print(f"Loaded {len(changes)} recipes with changes")
    ...
    # Verify all category names exist
    all_cat_names = set()
